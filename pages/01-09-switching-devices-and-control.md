...
![스위치](../assets/switching-devices-and-control-01.png)
...
![누름버튼 스위치 모델](../assets/switching-devices-and-control-02.png)
...
![표시등](../assets/switching-devices-and-control-03.png)
...
![스위치의 접점](../assets/switching-devices-and-control-04.png)

![스위치의 접점](../assets/switching-devices-and-control-05.png)
...
![스위치 배선](../assets/switching-devices-and-control-06.png)
...
![소자 설명](../assets/switching-devices-and-control-07.png)
...
![시퀀스 회로](../assets/switching-devices-and-control-08.png)

버튼을 누르면 접점이 연결되어 램프가 켜집니다.

**B접점(NC)을 이용한 램프 OFF**

![시퀀스 회로](../assets/switching-devices-and-control-09.png)
...
![스위치 종류](../assets/switching-devices-and-control-10.png)
...
![접점 추가](../assets/switching-devices-and-control-11.png)
...
![디지털 출력(Digital Output)](../assets/switching-devices-and-control-12.png)
...
![디지털 출력(Digital Output)](../assets/switching-devices-and-control-13.png)
...
![디지털 출력(Digital Output)](../assets/switching-devices-and-control-14.png)
...
![릴레이(Relay)](../assets/switching-devices-and-control-15.png)
...
![반도체 Package](../assets/switching-devices-and-control-16.png)
...
![반도체 Package](../assets/switching-devices-and-control-17.png)
...
![다이오드](../assets/switching-devices-and-control-18.png)
...
![다이오드의 동작 원리](../assets/switching-devices-and-control-19.png)
...
![다이오드의 동작 원리](../assets/switching-devices-and-control-20.png)
...
![다이오드의 동작 원리](../assets/switching-devices-and-control-21.png)
...
![트랜지스터 (=Bipolar Junction Transistor)](../assets/switching-devices-and-control-22.png)
...
![절연 (=Isolation)](../assets/switching-devices-and-control-23.png)
...
![절연 (=Isolation)](../assets/switching-devices-and-control-24.png)
...
![포토 커플러 (=Optocoupler)비교적 비싼 비용](../assets/switching-devices-and-control-25.png)
...
![Optocoupler vs Transistor](../assets/switching-devices-and-control-26.png)
...
![Optocoupler vs Transistor](../assets/switching-devices-and-control-27.png)
...
![MOSFET](../assets/switching-devices-and-control-28.png)
...
![IGBT](../assets/switching-devices-and-control-29.png)
...
![SSR (=Solid State Relay)](../assets/switching-devices-and-control-30.png)
