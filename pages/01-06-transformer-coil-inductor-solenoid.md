...
코일에 흐르는 전류가 변하면 자기장이 변하고, 이 변화는 다시 전압을 만들어 냅니다. 변압기, 인덕터, 솔레노이드는 모두 이 전자기 유도 현상을 서로 다른 목적으로 이용했습니다.
...
![변압기 (변압기) 설명 그림 1](../assets/transformer-coil-01.png)

*그림 1. 변압기 (변압기) 관련 자료입니다.*
...
![변압기 (변압기) 설명 그림 2](../assets/transformer-coil-02.png)

*그림 2. 변압기 (변압기) 관련 자료입니다.*
...
![복권 변압기 설명 그림 3](../assets/transformer-coil-03.png)

*그림 3. 복권 변압기 관련 자료입니다.*

1:1 변압기 로 노이즈 필터 로도 사용
...
![단권 변압기 설명 그림 4](../assets/transformer-coil-04.png)

*그림 4. 단권 변압기 관련 자료입니다.*

---

#### 코일과 변압기

![코일과 변압기 설명 그림 5](../assets/transformer-coil-05.png)

*그림 5. 코일과 변압기 관련 자료입니다.*
...
![코일과 변압기 설명 그림 6](../assets/transformer-coil-06.png)

*그림 6. 코일과 변압기 관련 자료입니다.*
...
![인덕터 설명 그림 7](../assets/transformer-coil-07.png)

*그림 7. 인덕터 관련 자료입니다.*

![인덕터 설명 그림 8](../assets/transformer-coil-08.png)
...
![인덕터의 이해 설명 그림 9](../assets/transformer-coil-09.png)

*그림 9. 인덕터의 이해 관련 자료입니다.*
...
![솔레노이드 설명 그림 10](../assets/transformer-coil-10.png)

*그림 10. 솔레노이드 관련 자료입니다.*
...
![솔레노이드 설명 그림 11](../assets/transformer-coil-11.png)

*그림 11. 솔레노이드 관련 자료입니다.*
