...
![전압(電壓, Voltage)](voltage-current-resistance/voltage-current-resistance-01.png)
...
![폐회로(Closed Circuit)](voltage-current-resistance/voltage-current-resistance-02.png)
...
![개회로(Open Circuit)](voltage-current-resistance/voltage-current-resistance-03.png)
...
![기준 전압](voltage-current-resistance/voltage-current-resistance-04.png)
...
![전자의 이동 방향](voltage-current-resistance/voltage-current-resistance-05.png)
...
![쇼트(단락, Short Circuit)](voltage-current-resistance/voltage-current-resistance-06.png)
...
![저항(抵抗, Resistance)](voltage-current-resistance/voltage-current-resistance-07.png)
...
![전압, 전류, 저항의 관계](voltage-current-resistance/voltage-current-resistance-08.png)
